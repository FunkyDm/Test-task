...
public class Main {
    public static void main(String[] args) {
        ...
        FlightFiltering.printFlights("Отфильтрованные полеты (исключаем где время вылета раньше текущего момента времени): ", filtered1);
        ...
        FlightFiltering.printFlights("Отфильтрованные полеты (исключаем где общее время, проведённое на земле, превышает 2 часа ):", filtered3);
    }
